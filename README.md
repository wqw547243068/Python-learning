...
- 【2020-02-06】python+pyecharts可视化新冠状病毒（武汉肺炎）分布，[示例](https://wqw547243068.github.io/Python-learning/data_mining/ncov.html)
   - 感染过程仿真[VirusBroadcast](https://github.com/KikiLetGo/VirusBroadcast)，java版本
- <iframe src="data_mining/ncov.html" scrolling="yes" border="0" frameborder="no" framespacing="0" allowfullscreen="true"  height="2400" width="100%"> </iframe>
